## Source: This script has been taken from the following Machine Learning competition:
## https://segpc-2021.grand-challenge.org
## This script prepares the submission file for the competition.
...
def coords(mask,sz,type_):
    """
    Convert the mask to the required format.

    Args:
        mask (np.array): Mask to be converted.
        sz (tuple): Size of the image.
        type_ (str): Type of mask to be converted.
...
for img in tqdm.tqdm(imgs):
    ...
    # convert the instances to the required format
    for ins in insts:
